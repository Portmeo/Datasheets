...
export const DatasheetService = {
  ...
  update: (dataSheet: DatasheetModel): Promise<DatasheetModel> => RequestHandlerService.put(`${BASE_URL}${CONSTANTS.REQUEST_ROUTES.DATASHEET}/${dataSheet._id}`, { body: dataSheet }),
